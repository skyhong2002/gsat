...
seq -w 154 |while read i; do
	curl -s -o pdf/apply-$i.pdf https://www.cac.edu.tw/apply110/Classification_readfile.php?fileid=$i
...
# Download Star
seq -w 154 |while read i; do
	curl -s -o pdf/star-$i.pdf https://www.cac.edu.tw/star110/Classification_readfile.php?fileid=$i
